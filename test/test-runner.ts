...
const SUBGRAPH_QUERY_ENDPOINT = 'http://127.0.0.1:8020/subgraphs/name/koil-finance';

export const runTestCases = async (groupName: string, testCases: TestCase[]): Promise<void> => {
